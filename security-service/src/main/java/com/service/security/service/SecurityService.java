...
import com.service.security.application.StatusListener;
import com.service.security.data.AlarmStatus;
import com.service.security.data.ArmingStatus;
import com.service.security.data.SecurityRepository;
...
public class SecurityService {
    ...
    public SecurityService(SecurityRepository securityRepository, InterfaceImageService imageService) {
    ...
    public void setArmingStatus(ArmingStatus armingStatus) {
        if (armingStatus == ArmingStatus.DISARMED) {
            ...
            // Cat detected
            if (securityRepository.isPreviousCatDetected()) {
                setAlarmStatus(AlarmStatus.ALARM);
            }

            for (Sensor sensor : getSensors().stream().toList()) {
    ...
    private void catDetected(Boolean cat) {
        securityRepository.setPreviousCatDetected(cat);
